...
const SectionHero = props => {
  ...
  return (
    <div className="carousel slide" data-ride="carousel">
      <div className="carousel-inner bg-container">
        {/* heroContent div would be the equivalent to static text */}
        ...
        <div className="carousel-item">
          <img className={css.image} src={image2} alt="Second slide" />
        </div>
        <div className="carousel-item">
          <img className={css.image} src={image3} alt="Third slide" />
        </div>
      </div>
    </div>
  );
